            ...
            <div class="details personal">
                ...
                <div class="fields">
                    <div class="input-field">
                        ...
                        <input type="text" placeholder="Nom du document" value="{{ old('nomDoc') }}" name="nomDoc">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" placeholder="Numéro de version du document" value="{{ old('numeroVersion') }}"
                            name="numeroVersion">
                        <span class="text-danger">
                            @error('numeroVersion')
                                {{ $message }}
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" placeholder=" Ex:Facture" value="{{ old('type') }}" name="type">
                        <span class="text-danger">
                            @error('type')
                                {{ $message }}
                            @enderror
